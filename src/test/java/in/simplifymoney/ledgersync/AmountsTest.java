...
class AmountsTest {
    ...
    @Test
    void readsWholeRupeeAmountBeforeStatedBalance() {
        assertEquals(
                new BigDecimal("5.00"),
                Amounts.first(
    ...
    @Test
    void readsWholeInrAmount() {
        assertEquals(
                new BigDecimal("25.00"),
                Amounts.first(
                        "Dear Customer, Acct XX9075 is debited with INR 25 "
                                + "on 04/07/2026 07:54. Info: UPI/STATIONERY. "
                                + "Avl Bal Rs.49,857.25"
                )
        );
    }
}
